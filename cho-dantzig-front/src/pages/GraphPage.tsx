  ...
  return (
    ...
    >
      ...
      <main className="flex flex-1 overflow-hidden relative z-10">
        ...
        <div className={`flex-1 relative transition-colors duration-300 overflow-hidden ${
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30">
            <div className={`border p-2 rounded-2xl shadow-2xl backdrop-blur-xl flex items-center gap-2 transition-all ${
              isDarkMode ? "bg-slate-950/90 border-white/10 shadow-black/80" : "bg-white/95 border-slate-200 shadow-slate-300/80"
            }`}>
               <GraphControls />
               {isRunning && (
        ...
        {/* Volet Latéral Droit */}
        <aside className={`w-80 border-l backdrop-blur-sm flex flex-col transition-colors duration-300 z-20 ${
